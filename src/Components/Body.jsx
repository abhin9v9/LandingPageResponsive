  ...
  return (
    <div className="space-y-4 lg:flex">
      ...
      <div className="lg:flex-1 lg:order-1">
          ...
          <p className="font-lato text-gray-400 ">With Hoster, get your website up and running in no less than 5 minutes with the most competitive pricing package ever</p>
